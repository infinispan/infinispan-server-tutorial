...
* Podman
+
`podman run --net=host -p 11222:11222 -e USER="admin" -e PASS="password" quay.io/infinispan/server:12.0`

* Docker
+
`docker run -it -p 11222:11222 -e USER="admin" -e PASS="password" infinispan/server:12.0`
